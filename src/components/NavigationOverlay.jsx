...
export default function NavigationOverlay({
  ...
  return (
    <div
      className="absolute inset-0 z-40 bg-[#0d1622]/94 backdrop-blur-md flex items-stretch p-3 sm:p-6 md:p-8 select-none scanline-overlay animate-in fade-in duration-200"
      onClick={onClose}
    >
      <div

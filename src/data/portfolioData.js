...
export const profile = {
  ...
  resumeUrl: '/Shri_Sanjaykumar_V_Resume.pdf',
  images: {
    profile: '/images/photo.jpeg',
    profileAlt: '/images/photo2.jpeg',
    professional: '/images/photo3.jpeg',
    og: '/images/photo4.jpeg',
  },
...
export const trackerNodes = [
  {
    id: 'node-campusllm',
    name: 'CampusLLM — University RAG Assistant',
    ...
    year: '2026',
    date: 'AUG 18, 2026',
    githubUrl: 'https://github.com/Shri-Sanjaykumar/CampusLLM-AI-Assistant',
    demoUrl: 'https://github.com/Shri-Sanjaykumar/CampusLLM-AI-Assistant',
    ...
    thumbnail: '/images/campusllm.jpg',
    featured: true,
    result: '~3.0s Average End-to-End Latency',
    tech: ['Python', 'Next.js', 'React', 'RAG', 'Vector Search', 'OpenAI API', 'FastAPI'],
    ...
    highlights: [
      'Dense vector embeddings & cosine semantic similarity ranking',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/Shri-Sanjaykumar',
    demoUrl: 'https://www.linkedin.com/in/shri-sanjaykumar-v-588bab28a/',
    shortDesc: 'Academic Intern — Generative AI & SAP Technologies. Enterprise RAG workflows and SAP BTP backend integration.',
    thumbnail: '/images/tforce.jpg',
    featured: true,
    confidential: true,
  ...
  {
    id: 'node-legitify',
    name: 'LEGITIFY — DevSecOps & Security Auditor',
    ...
    lat: 37.7749,
    lng: -122.4194,
    region: 'San Francisco, CA, USA / Cloud Grid',
    year: '2026',
    date: 'JUL 14, 2026',
    githubUrl: 'https://github.com/Shri-Sanjaykumar/LEGITIFY',
    demoUrl: 'https://github.com/Shri-Sanjaykumar/LEGITIFY',
  ...
  {
    id: 'node-solar',
    name: 'Solar Energy Forecasting — 7-Day ML Pipeline',
    ...
    year: '2026',
    date: 'JUN 28, 2026',
    githubUrl: 'https://github.com/Shri-Sanjaykumar/Solar-Energy-Forecasting',
    demoUrl: 'https://github.com/Shri-Sanjaykumar/Solar-Energy-Forecasting',
  ...
  {
    id: 'node-fintrack',
    name: 'FinTrack — Graph Debt Settlement Platform',
    ...
    year: '2026',
    date: 'MAY 10, 2026',
    githubUrl: 'https://github.com/Shri-Sanjaykumar/FinTrack',
    demoUrl: 'https://github.com/Shri-Sanjaykumar/FinTrack',
  ...
  },
  {
    ...
    year: '2025–2026',
    date: 'DEC 2025',
    githubUrl: 'https://github.com/Shri-Sanjaykumar/Cloud-Scalable-Architecture',
    demoUrl: 'https://github.com/Shri-Sanjaykumar/Cloud-Scalable-Architecture',
  ...
  },
  {
    ...
    name: 'Enterprise RAG & Context Routing Lab',
    ...
    date: 'ONGOING',
    githubUrl: 'https://github.com/Shri-Sanjaykumar',
    demoUrl: 'https://github.com/Shri-Sanjaykumar',
  ...
  },
  {
    ...
    name: 'Distributed Systems & Concurrency Lab',
